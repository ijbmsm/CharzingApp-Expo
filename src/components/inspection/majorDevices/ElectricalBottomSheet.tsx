...
interface ElectricalBottomSheetProps {
  visible: boolean;
  onClose: () => void;
...
export const ElectricalBottomSheet: React.FC<ElectricalBottomSheetProps> = ({
  visible,
  onClose,
  onSave,
  initialData,
    ...
    <Modal visible={visible} animationType="slide" presentationStyle="pageSheet" onRequestClose={onClose}>
      <SafeAreaView style={commonStyles.modalContainer} edges={['top', 'bottom']}>
        <View style={commonStyles.header}>
          ...
          <Text style={commonStyles.headerTitle}>전기 장치</Text>
